...
const SearchResult = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const data = await fetchRegionData("oceania");
        setRegionData(data);
      } catch (error) {
        console.error(error);
      } finally {
  ...
  return (
    <Box>
      <Box className="w-full h-80 relative flex justify-center items-center">
        <img
          src="https://www.cuddlynest.com/blog/wp-content/uploads/2021/01/aerial-view-palau-makal-island.jpg"
        ...
        <Box className="text-white">
          ...
          <div className="flex justify-center ">
            <Button
              ...
              onClick={() => {
                addAllToCart(regionData, 'Oceania');
              }}
            >
