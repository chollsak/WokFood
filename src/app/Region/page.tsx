                    ...
                    <div className='mt-28 flex flex-col-reverse md:flex-row'>
                        <div className='flex-1 md:mr-6'>
                            ...
                            <div className='flex-col justify-center items-center mb-8 mt-6'>
                                ...
                                <p className='text-md mb-3 text-gray-500'>Africa is the world's second-largest and second-most populous continent after Asia. At about 30.3 million km2 (11.7 million square miles) including adjacent islands, it covers 20% of Earth's land area and 6% of its total surface area.[9] With nearly 1.4 billion people as of 2021, it accounts for about 18% of the world's human population. Africa's population is the youngest among all the continents;[10][11] the median age in 2012 was 19.7, when the worldwide median age was 30.4.[12] Despite a wide range of natural resources, Africa is the least wealthy continent per capita and second-least wealthy by total wealth, ahead of Oceania. Scholars have attributed this to different factors including geography, climate,[13] corruption,[13] colonialism, the Cold War,[14][15] and neocolonialism. Despite this low concentration of wealth, recent economic expansion and a large and young population make Africa an important economic market in the broader global context. Africa has a large quantity of natural resources and food resources, including diamonds, sugar, salt, gold, iron, cobalt, uranium, copper, bauxite, silver, petroleum, natural gas, cocoa beans, and tropical fruit.</p>
                                <Button
                                    variant="contained"
                                    sx={{
                                        width: '200px',
...
North America covers an area of about 24,709,000 square kilometers (9,540,000 square miles), representing approximately 16.5% of the Earth's land area and 4.8% of its total surface area. It is the third-largest continent by size after Asia and Africa, and the fourth-largest continent by population after Asia, Africa, and Europe.</p>
                                <Button
                                    variant="contained"
                                    sx={{
                                        width: '200px',
