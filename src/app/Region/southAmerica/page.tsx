...
const SearchResult = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const data = await fetchRegionData("south-america");
        setRegionData(data);
      } catch (error) {
        console.error(error);
      } finally {
  ...
  return (
    <Box>
      <Box className="w-full h-80 relative flex justify-center items-center">
        <img
          src="https://southamericabackpacker.com/wp-content/uploads/2022/12/christ-the-redeemer.jpg"
        ...
        <Box className="text-white">
          ...
          <div className="flex justify-center ">
            <Button
              ...
              onClick={() => {
                addAllToCart(regionData, 'South America');
              }}
            >
