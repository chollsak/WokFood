...
const SearchResult = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const data = await fetchRegionData("middle-east");
        setRegionData(data);
      } catch (error) {
        console.error(error);
      } finally {
  ...
  return (
    <Box>
      <Box className="w-full h-80 relative flex justify-center items-center">
        <img
          src="https://assets.goal.com/images/v3/blt52810b275ccfe146/Ronaldo_Al_Nassr.jpg?auto=webp&format=pjpg&width=3840&quality=60"
        ...
        <Box className="text-white">
          ...
          <div className="flex justify-center ">
            <Button
              ...
              onClick={() => {
                addAllToCart(regionData, 'Middle-East');
              }}
            >
